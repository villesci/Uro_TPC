...
#wh
  #wh1
mod_wh1<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=wh1,iter=c(3,3,3,3),
...
#wh2
mod_wh2<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=wh2,iter=c(3,3,3,3),
...
#wh3
mod_wh3<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=wh3,iter=c(3,3,3,3),
...
#gb
  #gb1
mod_gb1<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=gb1,iter=c(3,3,3,3),
...
#gb2
mod_gb2<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=gb2,iter=c(3,3,3,3),
...
#gb3
mod_gb3<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=gb3,iter=c(3,3,3,3),
...
# oy
#oy1
mod_oy1<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=oy1,iter=c(3,3,3,3),
...
#oy2
mod_oy2<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=oy2,iter=c(3,3,3,3),
...
#oy3
mod_oy3<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=oy3,iter=c(3,3,3,3),
...
# bf
#bf1
mod_bf1<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=bf1,iter=c(3,3,3,3),
...
#bf2
mod_bf2<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=bf2,iter=c(3,3,3,3),
...
#bf3
mod_bf3<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=bf3,iter=c(3,3,3,3),
...
#fb
#fb1
mod_fb1<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=fb1,iter=c(3,3,3,3),
...
#fb2
mod_fb2<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=fb2,iter=c(3,3,3,3),
...
#fb3
mod_fb3<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=fb3,iter=c(3,3,3,3),
...
#sk
#sk1
mod_sk1<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=sk1,iter=c(3,3,3,3),
...
#sk2
mod_sk2<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=sk2,iter=c(3,3,3,3),
...
#sk3
mod_sk3<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=sk3,iter=c(3,3,3,3),
...
#wp
#wp1
mod_wp1<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=wp1,iter=c(3,3,3,3),
...
#wp2
mod_wp2<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=wp2,iter=c(3,3,3,3),
...
#wp3
mod_wp3<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=wp3,iter=c(3,3,3,3),
...
#hm
#hm1
mod_hm1<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=hm1,iter=c(3,3,3,3),
...
#hm2
mod_hm2<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=hm2,iter=c(3,3,3,3),
...
#hm3
mod_hm3<-nls_multstart(cal.length~rezende_2019(temp=temp,q10,a,b,c),data=hm3,iter=c(3,3,3,3),
...
#write.csv(peras_tab,"C:/Users/drewv/Documents/UMASS/Urosalpinx/TPC_MS_updated_tables/corr_table.csv",row.names=F)
...
testm<-lm(brkptx~spring+mean,brkpts)
car::vif(testm)
...
brkptym_wh<-lm(brkpty~seasonlength12,brkpts_wh)
summary(brkptym_wh)
