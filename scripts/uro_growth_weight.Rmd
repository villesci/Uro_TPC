...
wtTPC<-ggplot(all.pred,aes(x=temp,y=wt,group=pop))+geom_line(aes(x=temp,y=wt,color=pop,linetype=pop,size=pop))+
  ...
  scale_color_manual(values=c("dark violet","navy","forest green","gold","dark orange","tomato","dark violet","navy"),labels=c("Great Bay, NH","Woods Hole, MA","Oyster, VA","Beaufort, NC","Folly Beach, SC","Skidaway, GA","Willapa, WA","Humboldt, CA"),name="Population")+theme(text=element_text(family="arial",size=22))+theme(legend.position="none")
wtTPC
...
scoreswt<-data.frame("site" = c("Great Bay","Woods Hole","Oyster","Beaufort","Folly Beach","Skidaway","Willapa","Humboldt"),"breakpoint"=NA,"P Score"=NA,"Davies Test"=NA,"slope1"=NA,"CI slope 1"=NA,"slope2"=NA,"CI slope 2"=NA)

scoreswt[1,2]<-confint(seg.gb)[[1]]
scoreswt[2,2]<-confint(seg.wh)[[1]]
scoreswt[3,2]<-confint(seg.oy)[[1]]
scoreswt[4,2]<-confint(seg.bf)[[1]]
scoreswt[5,2]<-confint(seg.fb)[[1]]
scoreswt[6,2]<-confint(seg.sk)[[1]]
scoreswt[7,2]<-confint(seg.wp)[[1]]
scoreswt[8,2]<-confint(seg.hm)[[1]]

scoreswt[1,3]<-pscore.test(seg.gb,~temp)[[5]]
scoreswt[2,3]<-pscore.test(seg.wh,~temp)[[5]]
scoreswt[3,3]<-pscore.test(seg.oy,~temp)[[5]]
scoreswt[4,3]<-pscore.test(seg.bf,~temp)[[5]]
scoreswt[5,3]<-pscore.test(seg.fb,~temp)[[5]]
scoreswt[6,3]<-pscore.test(seg.sk,~temp)[[5]]
scoreswt[7,3]<-pscore.test(seg.wp,~temp)[[5]]
scoreswt[8,3]<-pscore.test(seg.hm,~temp)[[5]]

scoreswt[1,4]<-davies.test(seg.gb,~temp)[[5]]
scoreswt[2,4]<-davies.test(seg.wh,~temp)[[5]]
scoreswt[3,4]<-davies.test(seg.oy,~temp)[[5]]
scoreswt[4,4]<-davies.test(seg.bf,~temp)[[5]]
scoreswt[5,4]<-davies.test(seg.fb,~temp)[[5]]
scoreswt[6,4]<-davies.test(seg.sk,~temp)[[5]]
scoreswt[7,4]<-davies.test(seg.wp,~temp)[[5]]
scoreswt[8,4]<-davies.test(seg.hm,~temp)[[5]]

scoreswt[1,5]<-as.data.frame(slope(seg.gb))[1,1]
scoreswt[2,5]<-as.data.frame(slope(seg.wh))[1,1]
scoreswt[3,5]<-as.data.frame(slope(seg.oy))[1,1]
scoreswt[4,5]<-as.data.frame(slope(seg.bf))[1,1]
scoreswt[5,5]<-as.data.frame(slope(seg.fb))[1,1]
scoreswt[6,5]<-as.data.frame(slope(seg.sk))[1,1]
scoreswt[7,5]<-as.data.frame(slope(seg.wp))[1,1]
scoreswt[8,5]<-as.data.frame(slope(seg.hm))[1,1]  
  
scoreswt[1,6]<-as.data.frame(slope(seg.gb))[1,1]-as.data.frame(slope(seg.gb))[1,4]
scoreswt[2,6]<-as.data.frame(slope(seg.wh))[1,1]-as.data.frame(slope(seg.wh))[1,4]
scoreswt[3,6]<-as.data.frame(slope(seg.oy))[1,1]-as.data.frame(slope(seg.oy))[1,4]
scoreswt[4,6]<-as.data.frame(slope(seg.bf))[1,1]-as.data.frame(slope(seg.bf))[1,4]
scoreswt[5,6]<-as.data.frame(slope(seg.fb))[1,1]-as.data.frame(slope(seg.fb))[1,4]
scoreswt[6,6]<-as.data.frame(slope(seg.sk))[1,1]-as.data.frame(slope(seg.sk))[1,4]
scoreswt[7,6]<-as.data.frame(slope(seg.wp))[1,1]-as.data.frame(slope(seg.wp))[1,4]
scoreswt[8,6]<-as.data.frame(slope(seg.hm))[1,1]-as.data.frame(slope(seg.hm))[1,4]


scoreswt[1,7]<-as.data.frame(slope(seg.gb))[2,1]
scoreswt[2,7]<-as.data.frame(slope(seg.wh))[2,1]
scoreswt[3,7]<-as.data.frame(slope(seg.oy))[2,1]
scoreswt[4,7]<-as.data.frame(slope(seg.bf))[2,1]
scoreswt[5,7]<-as.data.frame(slope(seg.fb))[2,1]
scoreswt[6,7]<-as.data.frame(slope(seg.sk))[2,1]
scoreswt[7,7]<-as.data.frame(slope(seg.wp))[2,1]
scoreswt[8,7]<-as.data.frame(slope(seg.hm))[2,1]

scoreswt[1,8]<-as.data.frame(slope(seg.gb))[2,1]-as.data.frame(slope(seg.gb))[2,4]
scoreswt[2,8]<-as.data.frame(slope(seg.wh))[2,1]-as.data.frame(slope(seg.wh))[2,4]
scoreswt[3,8]<-as.data.frame(slope(seg.oy))[2,1]-as.data.frame(slope(seg.oy))[2,4]
scoreswt[4,8]<-as.data.frame(slope(seg.bf))[2,1]-as.data.frame(slope(seg.bf))[2,4]
scoreswt[5,8]<-as.data.frame(slope(seg.fb))[2,1]-as.data.frame(slope(seg.fb))[2,4]
scoreswt[6,8]<-as.data.frame(slope(seg.sk))[2,1]-as.data.frame(slope(seg.sk))[2,4]
scoreswt[7,8]<-as.data.frame(slope(seg.wp))[2,1]-as.data.frame(slope(seg.wp))[2,4]
scoreswt[8,8]<-as.data.frame(slope(seg.hm))[2,1]-as.data.frame(slope(seg.hm))[2,4]

#write.csv(scoreswt,"C:/Users/drewv/Documents/UMASS/data/weight_slopes.csv",row.names=F)
```
```{r}
...
Also, we see that four sites have POSITIVE secondd slopes, indicating that our Topt and thermal maxima may not be correct! We should
...
brkpts$pop<-as.character(brkpts$pop)
...
#means
brkpts[2,5]<-means[5,1]#hm
brkpts[8,5]<-means[4,1]#sk
brkpts[6,5]<-means[1,1]#bf
brkpts[3,5]<-means[3,1]#gb
brkpts[4,5]<-means[8,1]#wh
brkpts[5,5]<-means[7,1]#oy
brkpts[1,5]<-means[6,1]#wp
brkpts[7,5]<-means[2,1]#fb

#s.mean
brkpts[2,6]<-s.mean[5,1]#hm
brkpts[8,6]<-s.mean[4,1]#sk
brkpts[6,6]<-s.mean[1,1]#bf
brkpts[3,6]<-s.mean[3,1]#gb
brkpts[4,6]<-s.mean[8,1]#fb
brkpts[5,6]<-s.mean[7,1]#oy
brkpts[1,6]<-s.mean[6,1]#wp
brkpts[7,6]<-s.mean[2,1]#fb
#q.mean
brkpts[1,7]<-q[6,2]
brkpts[2,7]<-q[7,2]
brkpts[3,7]<-q[1,2]
...
#write.csv(brkpts,"C:/Users/drewv/Documents/UMASS/data/weight_brkpts.csv",row.names=F)
```
...
brkptxmq<-lm(brkptyq~seasonlength10,brkpts)
summary(brkptxmq)
...
ggplot(brkpts,aes(x=seasonlength10,y=brkptyq))+
  ...
  ylab("Maximum Weight (g)")+
  xlab("Length of Season (days) 10c")+
  theme(text=element_text(family="arial",size=22))+
  scale_color_manual(labels=c("Atlantic","Pacific"),name="Ocean", values=c('red','blue'))+
  scale_fill_manual(labels=c("Atlantic","Pacific"),name="Ocean", values=c('red','blue'))+theme(text=element_text(family="arial",size=22))
```
...
brkptxmq<-lm(brkptxq~t.mean,brkpts)
summary(brkptxmq)

ggplot(brkpts,aes(x=t.mean,y=brkptxq),group=interaction(oce))+
  geom_point(size=3,aes(color=oce))+geom_smooth(color="black",method="lm",se=F)+theme_classic()+
  ylab("Thermal Optima (C)")+
  xlab("90th Percentile Summer (C)")+
  theme(text=element_text(family="arial",size=22))+
  scale_color_manual(labels=c("Atlantic","Pacific"),name="Ocean", values=c('red','blue'))+
  scale_fill_manual(labels=c("Atlantic","Pacific"),name="Ocean", values=c('red','blue'))+theme(text=element_text(family="arial",size=22))
