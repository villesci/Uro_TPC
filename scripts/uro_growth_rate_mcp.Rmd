...
ggplot(predicted.gb,aes(x=temp,y=cal.length))+geom_line(aes(group=pop,x=temp,y=cal.length,color=pop,linetype=pop,size=pop))+
  ...
  scale_x_continuous(breaks=c(16,20,24,26,28,30))+geom_point(data=gb,aes(x=temp,y=cal.length))+scale_y_continuous(breaks=c(0,1,2,3,4,5))+theme(text=element_text(family="arial",size=22))+theme(text=element_text(family="arial",size=22))+theme(legend.position = "none")+scale_color_manual(values="purple") 
