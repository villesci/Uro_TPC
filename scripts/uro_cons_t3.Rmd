...
```{r,echo=F,warning=F}
scorescons<-data.frame("site" = c("Great Bay","Woods Hole","Oyster","Beaufort","Folly Beach","Skidaway","Willapa","Humboldt"),"P Score"=NA,"Davies Test"=NA,"CI Low"=NA,"CI High"=NA,"breakpoint"=NA)
scorescons[1,2]<-pscore.test(seg.gb,~Temp)[[5]]
scorescons[2,2]<-pscore.test(seg.wh,~Temp)[[5]]
scorescons[3,2]<-pscore.test(seg.oy,~Temp)[[5]]
scorescons[4,2]<-pscore.test(seg.bf,~Temp)[[5]]
scorescons[5,2]<-pscore.test(seg.fb,~Temp)[[5]]
scorescons[6,2]<-pscore.test(seg.sk,~Temp)[[5]]
scorescons[7,2]<-pscore.test(seg.wp,~Temp)[[5]]
scorescons[8,2]<-pscore.test(seg.hm,~Temp)[[5]]


scorescons[1,4]<-confint(seg.gb)[[2]]
scorescons[2,4]<-confint(seg.wh)[[2]]
scorescons[3,4]<-confint(seg.oy)[[2]]
scorescons[4,4]<-confint(seg.bf)[[2]]
scorescons[5,4]<-confint(seg.fb)[[2]]
scorescons[6,4]<-confint(seg.sk)[[2]]
scorescons[7,4]<-confint(seg.wp)[[2]]
scorescons[8,4]<-confint(seg.hm)[[2]]

scorescons[1,5]<-confint(seg.gb)[[3]]
scorescons[2,5]<-confint(seg.wh)[[3]]
scorescons[3,5]<-confint(seg.oy)[[3]]
scorescons[4,5]<-confint(seg.bf)[[3]]
scorescons[5,5]<-confint(seg.fb)[[3]]
scorescons[6,5]<-confint(seg.sk)[[3]]
scorescons[7,5]<-confint(seg.wp)[[3]]
scorescons[8,5]<-confint(seg.hm)[[3]]

scorescons[1,6]<-confint(seg.gb)[[1]]
scorescons[2,6]<-confint(seg.wh)[[1]]
scorescons[3,6]<-confint(seg.oy)[[1]]
scorescons[4,6]<-confint(seg.bf)[[1]]
scorescons[5,6]<-confint(seg.fb)[[1]]
scorescons[6,6]<-confint(seg.sk)[[1]]
scorescons[7,6]<-confint(seg.wp)[[1]]
scorescons[8,6]<-confint(seg.hm)[[1]]
...
```{r,echo=F,warning=F}
  ...
  "lato"=glm(brkpty~lat+oce,brkpts_con,family="gaussian"),
  "meano"=glm(brkpty~mean+oce,brkpts_con,family="gaussian"),
  "s.meano"=glm(brkpty~s.mean+oce,brkpts_con,family="gaussian"),
  "q.meano"=glm(brkpty~q.mean+oce,brkpts_con,family="gaussian"),
  "t.meano"=glm(brkpty~t.mean+oce,brkpts_con,family="gaussian"),
  "seasonlengtho10"=glm(brkpty~seasonlength10+oce,brkpts_con,family="gaussian"),
  "seasonlengtho16"=glm(brkpty~seasonlength16+oce,brkpts_con,family="gaussian"),
  "maxo"=glm(brkpty~max+oce,brkpts_con,family="gaussian"),
  ...
  "o*lat"=glm(brkpty~lat*oce,brkpts_con,family="gaussian"),
  "o*mean"=glm(brkpty~mean*oce,brkpts_con,family="gaussian"),
  "o*s.mean"=glm(brkpty~s.mean*oce,brkpts_con,family="gaussian"),
  "o*q.mean"=glm(brkpty~q.mean*oce,brkpts_con,family="gaussian"),
  "o*t.mean"=glm(brkpty~t.mean*oce,brkpts_con,family="gaussian"),
  "o*seasonlength10"=glm(brkpty~seasonlength10*oce,brkpts_con,family="gaussian"),
  "seasonlength16"=glm(brkpty~seasonlength16*oce,brkpts_con,family="gaussian"),
  "o*max"=glm(brkpty~max*oce,brkpts_con,family="gaussian")
  )
...
aictab(mods.brk_con)
   ...
   ggplot(brkpts_con,aes(x=mean,y=brkpty))+
      geom_point(aes(color=oce),size=3)+theme_classic()+geom_smooth(method="lm",se=F,color="black")+ylab(label="Consumption Rate \n log(oysters/day)")+scale_color_manual(labels=c("Atlantic","Pacific"),name="Ocean", values=c('red','blue'))+
    scale_fill_manual(labels=c("Atlantic","Pacific"),name="Ocean", values=c('red','blue'))+theme(text=element_text(family="arial",size=22))+xlab("Mean Temperature (°C)") 
...
```{r,echo=F,warning=F}
  ...
  "lato"=glm(brkptx~lat+oce,brkpts_con,family="gaussian"),
  "meano"=glm(brkptx~mean+oce,brkpts_con,family="gaussian"),
  "s.meano"=glm(brkptx~s.mean+oce,brkpts_con,family="gaussian"),
  "q.meano"=glm(brkptx~q.mean+oce,brkpts_con,family="gaussian"),
  "t.meano"=glm(brkptx~t.mean+oce,brkpts_con,family="gaussian"),
  "seasonlengtho10"=glm(brkptx~seasonlength10+oce,brkpts_con,family="gaussian"),
  "seasonlengtho16"=glm(brkptx~seasonlength16+oce,brkpts_con,family="gaussian"),
  "maxo"=glm(brkptx~max+oce,brkpts_con,family="gaussian"),
  ...
  "o*lat"=glm(brkptx~lat*oce,brkpts_con,family="gaussian"),
  "o*mean"=glm(brkptx~mean*oce,brkpts_con,family="gaussian"),
  "o*s.mean"=glm(brkptx~s.mean*oce,brkpts_con,family="gaussian"),
  "o*q.mean"=glm(brkptx~q.mean*oce,brkpts_con,family="gaussian"),
  "o*t.mean"=glm(brkptx~t.mean*oce,brkpts_con,family="gaussian"),
  "o*seasonlength10"=glm(brkptx~seasonlength10*oce,brkpts_con,family="gaussian"),
  "seasonlength16"=glm(brkptx~seasonlength16*oce,brkpts_con,family="gaussian"),
  "o*max"=glm(brkptx~max*oce,brkpts_con,family="gaussian")
  )
   
   aictab(mods.brk_con)
   summary(lm(brkptx~mean,brkpts_con))
   
   ggplot(brkpts_con,aes(x=mean,y=brkptx))+
      geom_point(aes(color=oce),size=3)+theme_classic()+geom_smooth(method="lm",se=F,color="black")+ylab(label="Thermal Optima (°C)")+
...
```{r,echo=F,warning=F}
  ...
  "lato"=glm(brkptyq~lat+oce,brkpts_con,family="gaussian"),
  "meano"=glm(brkptyq~mean+oce,brkpts_con,family="gaussian"),
  "s.meano"=glm(brkptyq~s.mean+oce,brkpts_con,family="gaussian"),
  "q.meano"=glm(brkptyq~q.mean+oce,brkpts_con,family="gaussian"),
  "t.meano"=glm(brkptyq~t.mean+oce,brkpts_con,family="gaussian"),
  "seasonlengtho10"=glm(brkptyq~seasonlength10+oce,brkpts_con,family="gaussian"),
  "seasonlengtho16"=glm(brkptyq~seasonlength16+oce,brkpts_con,family="gaussian"),
  "maxo"=glm(brkptyq~max+oce,brkpts_con,family="gaussian"),
  ...
  "o*lat"=glm(brkptyq~lat*oce,brkpts_con,family="gaussian"),
  "o*mean"=glm(brkptyq~mean*oce,brkpts_con,family="gaussian"),
  "o*s.mean"=glm(brkptyq~s.mean*oce,brkpts_con,family="gaussian"),
  "o*q.mean"=glm(brkptyq~q.mean*oce,brkpts_con,family="gaussian"),
  "o*t.mean"=glm(brkptyq~t.mean*oce,brkpts_con,family="gaussian"),
  "o*seasonlength10"=glm(brkptyq~seasonlength10*oce,brkpts_con,family="gaussian"),
  "seasonlength16"=glm(brkptyq~seasonlength16*oce,brkpts_con,family="gaussian"),
  "o*max"=glm(brkptyq~max*oce,brkpts_con,family="gaussian")
  )
   
   aictab(mods.brkyq)
   
   brkptxmq<-glm(brkptyq~mean,brkpts_con,family="gaussian")
   summary(brkptxmq)
   
   ggplot(brkpts_con,aes(x=mean,y=brkptyq))+
      geom_point(aes(color=oce),size=3)+geom_smooth(method="lm",se=F,color="black")+
      theme_classic()+ylab("Maximal Growth (g)")+
      scale_color_manual(labels=c("Atlantic","Pacific"),name="Ocean", values=c('red','blue'))+
      scale_fill_manual(labels=c("Atlantic","Pacific"),name="Ocean",
      values=c('red','blue'))+theme(text=element_text(family="arial",size=22))+
      xlab('Mean Temperature (°C)')
...
```{r,echo=F,warning=F}
  ...
  "lato"=glm(brkptxq~lat+oce,brkpts_con,family="gaussian"),
  "meano"=glm(brkptxq~mean+oce,brkpts_con,family="gaussian"),
  "s.meano"=glm(brkptxq~s.mean+oce,brkpts_con,family="gaussian"),
  "q.meano"=glm(brkptxq~q.mean+oce,brkpts_con,family="gaussian"),
  "t.meano"=glm(brkptxq~t.mean+oce,brkpts_con,family="gaussian"),
  "seasonlengtho10"=glm(brkptxq~seasonlength10+oce,brkpts_con,family="gaussian"),
  "seasonlengtho16"=glm(brkptxq~seasonlength16+oce,brkpts_con,family="gaussian"),
  "maxo"=glm(brkptxq~max+oce,brkpts_con,family="gaussian"),
  ...
  "o*lat"=glm(brkptxq~lat*oce,brkpts_con,family="gaussian"),
  "o*mean"=glm(brkptxq~mean*oce,brkpts_con,family="gaussian"),
  "o*s.mean"=glm(brkptxq~s.mean*oce,brkpts_con,family="gaussian"),
  "o*q.mean"=glm(brkptxq~q.mean*oce,brkpts_con,family="gaussian"),
  "o*t.mean"=glm(brkptxq~t.mean*oce,brkpts_con,family="gaussian"),
  "o*seasonlength10"=glm(brkptxq~seasonlength10*oce,brkpts_con,family="gaussian"),
  "seasonlength16"=glm(brkptxq~seasonlength16*oce,brkpts_con,family="gaussian"),
  "o*max"=glm(brkptxq~max*oce,brkpts_con,family="gaussian")
  )
   
   aictab(mods.brkxq)
   
   brkptxmq<-glm(brkptxq~seasonlength10,brkpts_con,family="gaussian")
   summary(brkptxmq)
