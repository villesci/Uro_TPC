...
aictab(mods.brk_con)
   summary(glm(brkpty~mean,brkpts_con,family="gaussian"))
...
```{r}
  ...
  "o*max"=glm(brkptx~max*oce,brkpts_con,family="gaussian")
   ...
   aictab(mods.brk_con)
   summary(glm(brkptx~mean,brkpts_con,family="gaussian"))
  ...
  "o*max"=glm(brkptyq~max*oce,brkpts_con,family="gaussian")
   ...
   ggplot(brkpts_con,aes(x=mean,y=brkptyq,color=oce),group=interaction(oce))+
  ...
  "o*max"=glm(brkptxq~max*oce,brkpts_con,family="gaussian")
   ...
   brkptxmq<-glm(brkptxq~max,brkpts_con,family="gaussian")
   summary(brkptxmq)
   
   ggplot(brkpts_con,aes(x=max,y=brkptxq))+
